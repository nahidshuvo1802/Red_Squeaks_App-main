...
MyVideoFeedController controller = Get.find<MyVideoFeedController>();

class CustomMyFeedCard extends StatefulWidget {
  const CustomMyFeedCard({
    super.key,
  ...
  @override
  State<CustomMyFeedCard> createState() => _CustomMyFeedCardState();
}

class _CustomMyFeedCardState extends State<CustomMyFeedCard> {
              ...
              Obx(() {
                ...
                return Positioned(
                  ...
                  child: Column(
                    children: [
                      _buildActionButton(
                        onTap: () => controller.likeVideo(widget.id),
                      ...
                      _buildActionButton(
                        onTap: () => controller.dislikeVideo(widget.id),
                      ...
                      _buildActionButton(
                        onTap: () {
                          ...
                          controller.shareVideo(widget.videoUrl,widget.id);
