...
//video get (my feed video)==================
  ...
  static String getTherapistBySpeciality(
          {required String specialityId, required int currentPage}) =>
  ...
  static String getSearchServiceOutlet(
          {required String userId, required String searchText}) =>
      "/outlet/retrive/category/$userId/search?query=$searchText";
  static String getServiceOutlet({
  ...
  static String getUserProfile({
    required String userId,
      ...
      "/user/retrive/$userId";
  static String getTherapistRegister({
    required String userId,
  }) =>
      "/user/retrive/$userId";
  ...
  static String getInvoiceByUser({
    required String userId,
  }) =>
  ...
  static String getServiceByOutlet({
    required String outlateId,
  }) =>
      "/service/retrive/for-user/outlet/$outlateId";
  static String getOrderHistory({
    required String userId,
  }) =>
  ...
  static String updateTherapistProfile({
    required String userId,
  }) =>
      "/user/update/$userId";
  static String dismisSingleNotification({
...
//============================= Send Message =======================
  ...
  static String upcommingBookingShow(
          {required String outletId, required String date}) =>
